...
//       <div className="max-w-7xl mx-auto px-14 sm:px-1  py-16 grid grid-cols-2 md:grid-cols-6 gap-10">
//         {/* Left Section */}
...
//               width={70}
//               height={70}
//               className="w-10 h-10 md:w-14 object-cover"
//             />
...
//             </h2>
//           </div>
//           <p className="text-neutral-600 text-sm font-medium leading-8 md:w-72">
  ...
  return (
    <footer className="w-full bg-white">
      <div
        className="
          max-w-7xl mx-auto 
          px-8 sm:px-20 md:px-10 lg:px-14 
          py-12 md:py-16 
      ...
      >
        ...
        <div className="space-y-5 md:col-span-2">
          <div className="flex items-center gap-2">
            <Image
              ...
              width={70}
              height={70}
              className="w-10 h-10 md:w-12 lg:w-14 object-cover"
            />
          ...
          <p className="text-neutral-600 text-sm md:text-[15px] font-medium leading-7 md:w-60 lg:w-72">
            We build high-quality MVPs to transform your ideas into reality.
          </p>
          ...
          <div className="flex gap-4">
            <Link
              href="#"
              className="w-9 h-9 md:w-10 md:h-10 flex items-center justify-center rounded-xl shadow-lg hover:border-[#2209A7] transition"
            >
              <Image src={x} alt="X (Twitter)" width={18} height={18} />
            </Link>
            <Link
              href="#"
              className="w-9 h-9 md:w-10 md:h-10 flex items-center justify-center rounded-xl border shadow-lg hover:border-[#2209A7] transition"
            >
              <Image src={linkedin} alt="LinkedIn" width={18} height={18} />
            </Link>
          </div>
        ...
        {/* Footer Links */}
        {footerLinks.map((section) => (
          <div key={section.title} className="mt-2 md:mt-0">
            <h3 className="text-black text-sm md:text-base font-semibold leading-8 mb-2">
              {section.title}
            </h3>
            <ul className="space-y-1">
              {section.links.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-zinc-600 text-sm md:text-[15px] font-medium leading-8 hover:text-[#2209A7] transition"
                  >
                    {link.name}
                  </Link>
                </li>
